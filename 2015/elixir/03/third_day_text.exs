...
defmodule ThirdDayTest do
  ...
  test "> = 2 houses" do
    assert ThirdDay.navigate(">") == 2
  end

  test "^>v< = 4 houses" do
    assert ThirdDay.navigate("^>v<") == 4
  end

  test "^v^v^v^v^v = 2 houses" do
    assert ThirdDay.navigate("^v^v^v^v^v") == 2
  end

  test "challenge A" do
    x = ThirdDay.navigate @input
    IO.puts "Challenge a: #{x}"
  end

  test "robo ^v = 3" do
    assert ThirdDay.robo_navigate("^v") == 3
  end
  ...
  test "robo ^v^v^v^v^v = 11" do
    assert ThirdDay.robo_navigate("^v^v^v^v^v") == 11
  end

  test "robo split instructions" do
    instr = String.to_char_list("v>v<vvv<<vv^v<v>vv>v<<<^^^^^<<")
    santa = [?v,?v,?v,?v,?<,?v,?v,?v,?v,?>,?<,?<,?^,?^,?<]
    robo = [?>,?<,?v,?<,?v,?^,?<,?>,?v,?v,?<,?^,?^,?^,?<]
    assert ThirdDay.split_instructions(instr) == {santa, robo}
  end

  test "challenge B" do
    x = ThirdDay.robo_navigate @input
    IO.puts "Challenge b: #{x}"
  end
